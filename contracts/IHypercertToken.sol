...
interface IHypercertToken {
    ...
    // TODO: this should be the same as the actual IHypcertToken interface
    /// @dev Returns the `creator` of the claim
    function owner(uint256 tokenID) external view returns (address creator);
}
